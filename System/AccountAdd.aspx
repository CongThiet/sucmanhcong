<%@ Page Title="QUẢN TRỊ NỘI DUNG" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="AccountAdd.aspx.cs" Inherits="System_AccountAdd" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="line_post_from">
        ...
        <div style="float: left; width: 87%;">
            <input id="txtUserName" runat="server" class="input_post_from" />
        </div>
    </div>
    <div class="line_post_from">
        <div class="label_post_from">
